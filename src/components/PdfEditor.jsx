...
const PdfEditor = ({ file, onBack }) => {
    ...
    const onPageLoadSuccess = (page) => {
        setNumPages(page.numPages); // This might be wrong, param is page object
        // Actually react-pdf onPageLoadSuccess passes the page object which has width/height
        setPageDims(prev => ({
            ...prev,
